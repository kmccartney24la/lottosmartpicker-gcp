...
const REMOTE = process.env.MULTI_MEGAMILLIONS_REMOTE_CSV_URL; // e.g. https://<r2>.r2.dev/multi/megamillions.csv
...
export async function GET() {
  ...
  const file = path.join(process.cwd(), 'public', 'data', 'multi', 'megamillions.csv');
