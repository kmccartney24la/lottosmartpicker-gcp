...
const addMqlListener = (mql: MediaQueryList, fn: (e: MediaQueryListEvent) => void) =>
  mql.addEventListener ? mql.addEventListener('change', fn) : mql.addListener(fn);
const removeMqlListener = (mql: MediaQueryList, fn: (e: MediaQueryListEvent) => void) =>
  mql.removeEventListener ? mql.removeEventListener('change', fn) : mql.removeListener(fn);
