export type GameKey = 'multi_powerball' | 'multi_megamillions' | 'multi_cash4life' | 'ga_fantasy5' | 'ca_superlotto_plus' | 'ca_fantasy5' | 'fl_lotto' | 'fl_jackpot_triple_play' | 'fl_fantasy5_midday' | 'fl_fantasy5_evening' | 'fl_pick5_midday' | 'fl_pick5_evening' | 'fl_pick4_midday' | 'fl_pick4_evening' | 'fl_pick3_midday' | 'fl_pick3_evening' | 'fl_pick2_midday' | 'fl_pick2_evening' | 'ny_nylotto' | 'ny_numbers_midday' | 'ny_numbers_evening' | 'ny_win4_midday' | 'ny_win4_evening' | 'ny_pick10' | 'ny_take5_midday' | 'ny_take5_evening' | 'ny_quick_draw' | 'ny_take5' | 'ny_numbers' | 'ny_win4' | 'ny_lotto' | 'ny_quick_draw_rep' | 'ny_pick10_rep';
export type LogicalGameKey = 'ny_take5' | 'ny_numbers' | 'ny_win4' | 'ny_lotto' | 'ny_pick10' | 'ny_quick_draw' | 'ca_superlotto_plus' | 'ca_fantasy5' | 'ca_daily3' | 'ca_daily4' | 'fl_cashpop' | 'fl_fantasy5' | 'fl_pick5' | 'fl_pick4' | 'fl_pick3' | 'fl_pick2' | 'multi_powerball' | 'multi_megamillions' | 'multi_cash4life';
...
export type EraGame = 'multi_powerball' | 'multi_megamillions' | 'multi_cash4life' | 'ga_fantasy5' | 'ca_superlotto_plus' | 'ca_fantasy5' | 'ny_take5' | 'ny_lotto' | 'fl_fantasy5' | 'fl_lotto' | 'fl_jackpot_triple_play';
...
export declare function fetchDigitRowsFor(logical: 'ny_numbers' | 'ny_win4' | 'fl_pick5' | 'fl_pick4' | 'fl_pick3' | 'fl_pick2' | 'ca_daily3' | 'ca_daily4', period: Period): Promise<DigitRowEx[]>;
