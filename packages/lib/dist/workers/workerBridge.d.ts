type Task = 'parseCanonicalCsv' | 'parseFlexibleCsv' | 'computeStats' | 'analyzeGame' | 'generateTicket' | 'computeDigitStats' | 'computePick10Stats' | 'computeQuickDrawStats' | 'generatePick10Ticket' | 'generateQuickDrawTicket';
