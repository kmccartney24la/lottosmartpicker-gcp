...
const LOTTO_PRIZES = {
    ...
    multi_megamillions: [
        ...
        },
        {
            ...
            special: false,
            payoutKind: 'fixed-with-multiplier',
            notes: 'Amount and multiplier rules depend on draw date and jurisdiction; California pays pari-mutuel.',
        },
        {
            kind: 'lotto',
            code: '4+MB',
...
function digitPrizeTableFor(key) {
...
/* ------------------------------------------------------------------ */
function buildPoolTiers(matchDomain) {
    const tiers = [];
 ...
 */
export function prizeTableFor(game, opts) {
